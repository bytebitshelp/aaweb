...
const CrochetPage = () => {
  ...
  const fetchArtworks = async () => {
    try {
      ...
      if (error) {
        console.error('Error fetching crochet artworks:', error)
        setArtworks([])
      } else {
        setArtworks(data || [])
      }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading crochet items...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-forest-green to-green-700 text-white py-20">
        <div className="container-max text-center">
          <h1 className="text-5xl font-bold mb-6">Crochet</h1>
      ...
      <div className="container-max py-12">
        {artworks.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">No Crochet Items Found</h3>
            <p className="text-gray-600 mb-8">
              Check back soon for new crochet creations!
            </p>
          </div>
        ) : (
          <>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-2xl font-bold text-gray-900">
                Crochet Collection ({artworks.length} items)
              </h2>
            </div>
